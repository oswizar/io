...
public class Main {
    public static void main(String args[]) {
        try { // ��ֹ�ļ��������ȡʧ�ܣ���catch��׽���󲢴�ӡ��Ҳ����throw  
        	...
        	File[] files=(new File("F:\\监管报送\\数据\\20191128")).listFiles();
        	...
        	for(File f:files) {
                ...
                File writename = new File("F:\\监管报送\\数据\\20191129\\"+fileNameCopy); // ���·�������û����Ҫ����һ���µ�output��txt�ļ�
                ...
                while (line != null) {
                    ...
                    if(!line.startsWith("prompt")&&!(line.startsWith("spool"))) {
